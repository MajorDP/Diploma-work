        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white rounded-lg shadow p-6">
              <h2 className="text-2xl font-bold mb-4">Subscribtion Plans</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow hover:shadow-lg duration-200 p-6">
              ...
              {platform.userSupport.length > 0 ? (
                ...
                <p className="flex flex-row items-center mt-2">
                  <XIcon className="w-4 h-4 text-red-800" /> None available
                </p>
              )}
            </div>
          </div>
